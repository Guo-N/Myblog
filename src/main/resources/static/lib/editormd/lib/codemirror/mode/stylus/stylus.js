    ...
    var tokenBase = function(stream, state) {
      ...
      if (stream.match(/[\w-]*/i)) {
        ...
        if(cssProperties[word] !== undefined) {
          ...
          // By themes.default.assets.fonts variable-2
          return "variable-2";
        }
      }
